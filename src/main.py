...
print("\nValores ever_married sem AVC: \n", avc[avc.stroke == 0].ever_married.value_counts())
print("\nValores ever_married com AVC: \n", avc[avc.stroke == 1].ever_married.value_counts())
print("\nValores smoking_status: \n",avc.smoking_status.value_counts())
print("\nValores smoking_status sem AVC: \n",avc[avc.stroke == 0].smoking_status.value_counts())
print("\nValores smoking_status com AVC: \n",avc[avc.stroke == 1].smoking_status.value_counts())
print("\nValores work_type: \n",avc.work_type.value_counts())
print("\nValores work_type sem AVC: \n",avc[avc.stroke == 0].work_type.value_counts())
print("\nValores work_type com AVC: \n",avc[avc.stroke == 1].work_type.value_counts())
print("\nValores gender: \n",avc.gender.value_counts())
print("\nValores gender sem AVC: \n",avc[avc.stroke == 0].gender.value_counts())
print("\nValores gender com AVC: \n",avc[avc.stroke == 1].gender.value_counts())
print("\nValores Residence_type: \n",avc.Residence_type.value_counts())
print("\nValores Residence_type sem AVC: \n",avc[avc.stroke == 0].Residence_type.value_counts())
print("\nValores Residence_type com AVC: \n",avc[avc.stroke == 1].Residence_type.value_counts())
